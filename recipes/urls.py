...
urlpatterns = [
    ...
    path('recipes/ingredient/<int:pk>/', views.RecipesByIngredient.as_view(), name='recipes_by_ingredient'),
    path('recipes/category/<int:pk>/', views.RecipesByCategory.as_view(), name='recipes_by_category'),
]
